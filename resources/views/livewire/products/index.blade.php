        ...
        <div class="bg-white border-b">
            <div class="container mx-auto px-4 py-3">
                <div class="flex items-center flex-wrap gap-2 text-sm">
                    ...
                    <span class="text-gray-700">Termékek</span>
                    @if ($search)
                        <span class="text-gray-500">&gt;</span>
                        <span class="text-gray-700">Keresés: "{{ $search }}"</span>
                    @endif
                </div>
            </div>
        </div>
            ...
            <div class="grid md:grid-cols-[300px_1fr] gap-8">
                ...
                <div>
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                        <div>
                            @if ($search)
                                <h1 class="text-2xl font-bold">Keresés: "{{ $search }}"</h1>
                            @else
                        ...
                        <!-- Active Filters -->
                        @php
                            $hasActiveFilters = collect($selectedFilters)->flatten()->isNotEmpty() || $search;
                        @endphp
                        @if ($hasActiveFilters)
                    ...
                    @else
                        <div class="bg-white rounded-lg shadow p-8 text-center">
                            ...
                            @if ($search)
                                <p class="text-gray-600 mb-4">"{{ $search }}" keresésre nem található termék.</p>
                            @else
